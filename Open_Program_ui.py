...
class Ui_windowStart(object):
    def setupUi(self, windowStart):
        ...
        icon = QtGui.QIcon("icos/cogweel.ico")
        self.actionSettings.setIcon(icon)
        self.actionSettings.setObjectName("actionSettings")
        self.exitAction = QtWidgets.QAction(windowStart)
        icon = QtGui.QIcon("icos/exit.ico")
        self.exitAction.setIcon(icon)
        self.exitAction.setObjectName("exitAction")
        self.actionDataBase = QtWidgets.QAction(windowStart)
        icon = QtGui.QIcon("icos/database.ico")
        ...
        self.menuButton.addAction(self.actionDataBase)
    ...
    def retranslateUi(self, windowStart):
        ...
        self.actionDataBase.setText(_translate("windowStart", "Используемая база данных"))
